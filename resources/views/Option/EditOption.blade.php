            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="Post" action="/update/{{$option->id}}">
                            @csrf
                            @method('PATCH')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="contents" type="text" class="form-control @error('contents') is-invalid @enderror" name="contents" value="{{ old('contents') }}" required autocomplete="contents" autofocus>
