...
class TransPro2B extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure2B = "DROP PROCEDURE IF EXISTS `pr_postid2B`;
       CREATE  PROCEDURE `pr_postid2B`(IN `bid` BIGINT UNSIGNED, IN `pid` BIGINT UNSIGNED)
       BEGIN
