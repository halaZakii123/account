...
class TransPro2A extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        $procedure2A = "DROP PROCEDURE IF EXISTS `pr_postid2A`;
        CREATE  PROCEDURE `pr_postid2A`(IN `bid` BIGINT UNSIGNED, IN `pid` BIGINT UNSIGNED)
        BEGIN
